...
export default function KPIStrip({ kpis, dateRange, percentile, repeatThreshold }) {
  const rangLabel = dateRange === 0 ? 'All time' : `Last ${dateRange} days`
  const repeatLabel = repeatThreshold === 1
    ? '1+ booking'
